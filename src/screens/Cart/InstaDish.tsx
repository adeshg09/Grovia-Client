...
/* Interface */
type PropsInstaDish = NativeStackScreenProps<AppStackParamList, 'InstaDish'>

// -------------------------------------------------------------------------------------------------------------------------

/**
 * Component to create the InstaDish Screen.
 *
 * @component
 */
const InstaDish: React.FC<PropsInstaDish> = ({ navigation }) => {
	/* Hooks */
